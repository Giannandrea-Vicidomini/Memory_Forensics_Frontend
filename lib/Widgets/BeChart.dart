...
class BeChart extends StatefulWidget {

  List<charts.Series<BulkExtractorMatch, String>> _seriesPieData;
  String title;

  BeChart(this._seriesPieData, this.title);

  @override
  _BeChartState createState() => _BeChartState(this._seriesPieData, this.title);
}

class _BeChartState extends State<BeChart> {

  List<charts.Series<BulkExtractorMatch, String>> _seriesPieData;
  String title;

  _BeChartState(this._seriesPieData, this.title);
